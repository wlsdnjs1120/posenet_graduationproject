package com.jinwon.poseestimation.pushUp//package camera.hj.cameracontroller.decoder;
//
...
//    {
//        { 1, 2 }, { 1, 5 }, { 2, 3 }, { 3, 4 }, { 5, 6 }, { 6, 7 }, { 1, 8 }, { 1, 11 },{ 1, 0 }
...
//    private double thresh_h;
//    private double thresh_l;
//    private double thresh_score;
//    public double angle;
//    public double angle_score; >
//
//
//    public double angElbow1;
//    public double angElbow2;
//    public int [] oldElbow;
//    public double angThresh = 10;
//
//    fwc_counter() {
//        super();
//        this.thresh_h = 140;
...
//    }
//
//    int update (ArrayList<HashMap> keypoint){             //
//        // single img : 1person-1pt_dict , default count N0.0-person's action
//        // find Hip-Knee
...
//    }
//
//    int action_score (ArrayList<HashMap> keypoint){          //
//        // single img : 1person-1pt_dict , default count N0.0-person's action
//        // find Hip-Knee
//        HashMap<String, Object> human = keypoint . get (0);
